...
class Product{
  ...
  rating;
  priceCents;
  constructor(productDetails){//converting object to class
  ...
  getStarsurl(){
    return ` images/ratings/rating-${this.rating.stars *10}.png`;//each product able to construcct its stars
  }
  getPrice(){
...
const xhr=new XMLHttpRequest();
  xhr.addEventListener('load',() => {
   ...
   products=JSON.parse(xhr.response).map((productDetails)=>{//converting to class 
 ...
 console.log('loadProducts');
  //  console.log(products); array to class
...
loadProducts();//work same as below
